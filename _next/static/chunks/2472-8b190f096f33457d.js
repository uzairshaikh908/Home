(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2472], {
        ...
        89872: function(e, t, r) {
            ...
            function u(e, t) {
                return (0, o.normalizePathTrailingSlash)((0, n.addPathPrefix)(e, "/corporate-insurance-v2"))
        ...
        33728: function(e, t, r) {
            ...
            function j(e) {
                ...
                return (0, o.useInsertionEffect)(() => {
                    ...
                    n.pendingPush && (0, l.createHrefFromUrl)(new URL(window.location.href)) !== o ? (n.pendingPush = !1, w && w(u, "", o)) : M && M(u, "", o), r(t)
                }, [t, r]), null
            }
            let C = () => ({
                ...
                M = window.history.replaceState.bind(window.history);
            ...
            function A(e) {
                let {
                    ...
                    children: c,
                    assetPrefix: v
                } = e, S = (0, o.useMemo)(() => (0, f.createInitialRouterState)({
                    buildId: t,
                    children: c,
                    initialCanonicalUrl: l,
                    initialTree: n,
                    ...
                    initialHead: r
                }), [t, c, l, n, r]), [R, A, x] = (0, s.useReducerWithReduxDevtools)(S);
                (0, o.useEffect)(() => {
                    E = null
                }, []);
                let {
                    canonicalUrl: N
                } = (0, s.useUnwrapState)(R), {
                    searchParams: I,
                    pathname: D
                } = (0, o.useMemo)(() => {
                ...
                if (k.mpaNavigation) {
                    if (O.pendingMpaPath !== N) {
                        let e = window.location;
                        k.pendingPush ? e.assign(N) : e.replace(N), O.pendingMpaPath = N
                    ...
                    return window.addEventListener("popstate", e), () => {
                        w && (window.history.pushState = w), M && (window.history.replaceState = M), window.removeEventListener("popstate", e)
                    }
                }, [A]);
                let {
                    cache: H,
                    ...
                    nextUrl: G,
                    focusAndScrollRef: $
                } = (0, s.useUnwrapState)(R), W = (0, o.useMemo)(() => (0, y.findHeadInCache)(H, B[1]), [H, B]), X = o.default.createElement(h.RedirectBoundary, null, W, H.subTreeData, o.default.createElement(_.AppRouterAnnouncer, {
                    tree: B
                }));
                return o.default.createElement(o.default.Fragment, null, o.default.createElement(j, {
                    appRouterState: (0, s.useUnwrapState)(R),
                    sync: x
        ...
        18640: function(e, t, r) {
            ...
            function g(e, t) {
                let {
                    ...
                    hash: O
                } = r, R = (0, u.createHrefFromUrl)(r), T = "push" === m;
                ...
                return y.prefetchQueue.bump(A), A.then(t => {
                    let [f, h, y] = t;
                    ...
                    for (let t of f) {
                        ...
                        if (null === h && (h = (0, i.applyRouterStatePatchToTree)(d, M, f)), null !== h) {
                            if ((0, c.isNavigatingToNewRootLayout)(g, h)) return b(e, P, R, T);
                            ...
                            let S = (0, s.shouldHardNavigate)(d, g);
                            for (let e of (S ? (E.status = n.CacheStates.READY, E.subTreeData = m.subTreeData, (0, a.invalidateCacheBelowFlightSegmentPath)(E, m, u), P.cache = E) : i && (P.cache = E), m = E, g = h, v(f))) {
                                let t = [...u, ...e];
                                "__DEFAULT__" !== t[t.length - 1] && j.push(t)
                            }
                        }
                    }
                    return P.previousTree = e.tree, P.patchedTree = g, P.canonicalUrl = h ? (0, u.createHrefFromUrl)(h) : R, P.pendingPush = T, P.scrollableSegments = j, P.hashFragment = O, P.shouldScroll = S, (0, d.handleMutable)(e, P)
                }, () => e)
            }("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
                value: !0
            }), Object.assign(t.default, t), e.exports = t.default)
        ...
        26746: function(e, t, r) {
            ...
            function o(e) {
                return (0, n.pathHasPrefix)(e, "/corporate-insurance-v2")
            }("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
                value: !0
            }), Object.assign(t.default, t), e.exports = t.default)
        },
        ...
        97950: function(e, t, r) {
            ...
            function I(e, t) {
                var r = e._chunks,
                    n = r.get(t);
                return n || (n = new S("pending", null, null, e), r.set(t, n)), n
            }

            function D(e, t) {
                if ("resolved_model" === (e = I(e, t)).status && A(e), "fulfilled" === e.status) return e.value;
                throw e.reason
            }
            ...
            function F(e, t) {
                ...
                o.read().then(function t(c) {
                    var d = c.value;
                    if (c.done) N(e, Error("Connection closed."));
                    else {
                        var p = 0,
                            _ = e._rowState,
                            h = e._rowID,
                                        ...
                                        ! function(e, t, n) {
                                            ...
                                            if (n = function(e) {
                                                ...
                                                if (u) {
                                                    var f = u;
                                                    f.status = "blocked"
                                                } else f = new S("blocked", null, null, e), o.set(t, f);
                                                n.then(function() {
                                                    return C(f, c)
                                                }, function(e) {
                                                    return j(f, e)
                                                })
                                            } else u ? C(u, c) : o.set(t, new S("resolved_module", c, null, e))
                                        }(b, h, y);
                                        break;
                                    case 72:
                                        ...
                                        break;
                                    case 69:
                                        p = (y = JSON.parse(y)).digest, (y = Error("An error occurred in the Server Components render. The specific message is omitted in production builds to avoid leaking sensitive details. A digest property is included on this error instance which may provide additional details about the nature of the error.")).stack = "Error: " + y.message, y.digest = p, (m = (p = b._chunks).get(h)) ? j(m, y) : p.set(h, new S("rejected", null, y, b));
                                        break;
                                    case 84:
                                        b._chunks.set(h, new S("fulfilled", y, null, b));
                                        break;
                                    default:
                                        (m = (p = b._chunks).get(h)) ? (b = m, h = y, "pending" === b.status && (y = b.value, p = b.reason, b.status = "resolved_model", b.value = h, null !== y && (A(b), T(b, y, p)))) : p.set(h, new S("resolved_model", y, null, b))
                                }
        ...
        17869: function(e, t) {
            ...
            function R(e, t, n) {
                var o, u = {},
                    ...
                    l = null;
                if (null != t)
                    for (o in void 0 !== t.ref && (l = t.ref), void 0 !== t.key && (a = "" + t.key), t) P.call(t, o) && !O.hasOwnProperty(o) && (u[o] = t[o]);
            ...
            t.Children = {
                ...
                var o = h({}, e.props),
                    ...
                    l = e._owner;
                if (null != t) {
                    if (void 0 !== t.ref && (a = t.ref, l = S.current), void 0 !== t.key && (u = "" + t.key), e.type && e.type.defaultProps) var i = e.type.defaultProps;
                    for (s in t) P.call(t, s) && !O.hasOwnProperty(s) && (o[s] = void 0 === t[s] && void 0 !== i ? i[s] : t[s])
                }
        ...
        21756: function(e, t) {
            ...
            t.unstable_IdlePriority = 5, t.unstable_ImmediatePriority = 1, t.unstable_LowPriority = 4, t.unstable_NormalPriority = 3, t.unstable_Profiling = null, t.unstable_UserBlockingPriority = 2, t.unstable_cancelCallback = function(e) {
                ...
                return l = u + l, e = {
                    ...
                    expirationTime: l,
                    sortIndex: -1
                }, u > a ? (e.sortIndex = u, r(f, e), null === n(c) && e === n(f) && (b ? (g(O), O = -1) : b = !0, x(P, u - a))) : (e.sortIndex = l, r(c, e), y || h || (y = !0, A())), e
        ...
        31824: function(e, t) {
            ...
            let r = "nxtP",
                ...
                I = "You can not use getStaticProps or getStaticPaths with getServerSideProps. To use SSG, please remove getServerSideProps",
                ...
                F = "Your `getServerSideProps` function did not return an object. Did you forget to add a `return`?",
                ...
                V = { ...Y,
                    GROUP: {
                        server: [Y.reactServerComponents, Y.actionBrowser, Y.appMetadataRoute, Y.appRouteHandler],
                        nonClientServerTarget: [Y.middleware, Y.api],
                        app: [Y.reactServerComponents, Y.actionBrowser, Y.appMetadataRoute, Y.appRouteHandler, Y.serverSideRendering, Y.appPagesBrowser]
                    }
                },
                K = {
